...
import { getNextSemester } from "@/lib/academic-term";
...
export default function AutoGenerateDialog({
  ...
  activePlanId,
  onComplete,
}: Readonly<AutoGenerateDialogProps>) {
    ...
    try {
      ...
      const res = await autoGeneratePlan(
        ...
        pIds,
        {
          ...
          startYear: year,
          breadthPackage,
          targetCredits: degreeCreditTarget,
        },
        setProgress
      );
      ...
      if (breadthPackage) {
        localStorage.setItem(
          `gradtracker:breadthPackage:${studentId}:${res.planId}`,
          breadthPackage.id
        );
      }
                ...
                <VStack gap="4" align="stretch">
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        <Box
                          bg={hasErrors ? "orange.subtle" : "blue.subtle"}
                          borderRadius="lg"
                          p="4"
                          textAlign="center"
                        >
                          <HStack gap="2" justify="center" mb="2">
                            ...
                            <Text
                              fontWeight="600"
                              color={hasErrors ? "orange.fg" : "blue.fg"}
                            >
                              {hasErrors
                        ...
                        {hasErrors && (
                          ...
                          >
                            ...
                            <VStack gap="1" align="stretch">
                              {errors.map((issue) => (
                                <HStack key={issue.code} gap="1.5" fontSize="xs">
                ...
                <VStack gap="5" align="stretch">
                      ...
                      <VStack gap="1" align="stretch">
                        {plans.map((plan) => (
                          <Button
                            ...
                            colorPalette={
                              selectedPlanId === plan.id ? "blue" : "gray"
                            }
                            borderRadius="lg"
                  ...
                  <Box>
                    ...
                    <ProgramSelector
                      ...
                      typeOrder={["MAJOR", "MINOR", "CERTIFICATE"]}
                      maxH="220px"
                      ...
                      {BREADTH_PACKAGES.map((pkg) => {
                        ...
                        return (
                          <Box
                            ...
                            borderWidth="1px"
                            borderColor={
                              isSelected ? "blue.500" : "border.subtle"
                            }
